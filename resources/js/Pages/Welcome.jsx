...
import bg from '@/Images/wp1889507.jpg';
            ...
            <div className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0 after:bg-slate-400"
               style={{
                ...
                <div className="fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    <h1 className='text-white text-4xl mt-2 font-bold'> Festival Playlist 1.0 </h1>
                    ...
                    <div className="modal">
                        <div className="modal-box relative">
                            ...
                            <h1 className='text-lg font-bold text-white bg-red'> Festival Playlist 1.0  </h1>
